...
import { Table, Avatar, Tag, Tooltip } from '@douyinfe/semi-ui';
...
export const HotArea = () => {
  ...
  return <>
  <Table columns={columns111} dataSource={dataSource} rowSelection={rowSelection} scroll={scroll} />
  </>;
}